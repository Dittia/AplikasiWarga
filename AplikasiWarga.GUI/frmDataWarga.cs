...
"Belum Kawin", "Kawin", "Cerai Hidup", "Cerai Mati" });
            ...
            btnUbah = AddButton("Ubah", new Point(340, 270), btnUbah_Click);
            // --- DataGridView ---
        ...
        private void btnUbah_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(selectedNIK))
            {
            ...
            // Validasi input seperti btnSimpan
            if (string.IsNullOrWhiteSpace(txtNamaLengkap.Text))
            {
                MessageBox.Show("Nama Lengkap harus diisi.", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtNamaLengkap.Focus();
            ...
            // Ambil data dari input form
            string nik = selectedNIK; // Gunakan NIK yang dipilih
            string namaLengkap = txtNamaLengkap.Text.Trim();
            DateTime tanggalLahir = dtpTanggalLahir.Value;
            string jenisKelamin = cmbJenisKelamin.Text;
            string alamat = txtAlamat.Text.Trim();
            ...
            if (success)
            {
                MessageBox.Show("Data warga berhasil diubah!", "Sukses", MessageBoxButtons.OK, MessageBoxIcon.Information);
                LoadDataToGrid();
                ResetForm();
            }
        }
